...
type Page = 'home' | 'jobs' | 'workers' | 'repos' | 'badges' | 'gitlab-onboard'
...
export function App() {
  ...
  // Exception: gitlab-onboard page should show the onboarding flow
  if (!auth.loading && (!auth.authenticated || page === 'home') && page !== 'gitlab-onboard') {
